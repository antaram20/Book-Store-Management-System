...
class UserPage(object):
    def __init__(self, root, color, font, dbConnection, userInfo):
        ...
        self.screen_width = int(self.root.winfo_screenwidth() * 3 / 4)
        self.screen_height = int(self.root.winfo_screenheight() * 3 / 4)
    ...
    def gui_init(self):
        ...
        self.booksInfoFrame = BooksBought(
...
class BooksBought(object):
    ...
    def gui_init(self):
        ...
        self.uploadedFilesLabel = Label(
            frame_up, text="BooksBought", font=self.font, bg=self.color)
        ...
        self.booksDisplay.column('#1', stretch=True, width=int(self.width / 5))
        self.booksDisplay.column('#2', stretch=True, width=int(self.width / 5))
        self.booksDisplay.column('#3', stretch=True, width=int(self.width / 5))
        self.booksDisplay.column('#4', stretch=True, width=int(self.width / 5))
        self.booksDisplay.column('#5', stretch=True, width=int(self.width / 5))
